    ...
    public partial class AddPhoneNumberColumn : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMessagesTable", x => x.MessageId);
                    table.ForeignKey(
                        name: "FK_UserMessagesTable_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProfileDetailsTable", x => x.ProfileDetailsId);
                    table.ForeignKey(
                        name: "FK_UserProfileDetailsTable_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMessagesTable_SenderId",
                table: "UserMessagesTable",
                column: "SenderId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProfileDetailsTable_UserId",
                table: "UserProfileDetailsTable",
                column: "UserId",
                unique: true);
        }
