...
namespace MurderGame.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> FacebookCallback()
        {
            ...
            var user = await _facebookService.HandleFacebookSignUpAsync(email, name);
        ...
        public async Task<IActionResult> FacebookLoginCallback()
        {
            ...
            var user = await _facebookService.HandleFacebookLoginAsync(info.LoginProvider, info.ProviderKey);
        ...
        public async Task<IActionResult> TwitterCallback()
        {
            ...
            // Kullanıcıyı kontrol et ve yoksa kaydet
            var user = await _twitterService.HandleTwitterSignUpAsync(email, name);
        ...
        public async Task<IActionResult> GoogleCallback()
        {
            ...
            // Kullanıcıyı kontrol et ve yoksa kaydet
            var user = await _googleService.HandleGoogleLoginAsync(email, name);
